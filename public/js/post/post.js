class Post {
    ...
    subirImagenPost (file, uid) {
        ...
        err => {
            Materialize.toast(`Error al subir el archivo => ${err.message}`, 4000)
        },
        ()=> {
            task.snapshot.ref.getDownloadURL()
                .then(url => {
                    ...
                    Materialize.toast(`Error al obtener la URL de descarga => ${e}`, 4000)
                })
        }
        )
    }
    ...
    obtenerTemplatePostVacio () {
      return `<article class="post">
        ...
        <div class="post-video">
            <iframe type="text/html" width="500" height="385" src='https://www.youtube.com/embed/lPbLIbCyVzc?ecver=2'
